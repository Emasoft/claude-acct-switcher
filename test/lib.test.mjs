...
//
// These tests guard the header right-side action chrome (settings/help
// icons + status pills), the exhausted-banner colour palette swap, the
// Config tab's anchor-ID + table-of-contents structure, the Session
// Monitor explicit privacy-callout block, and the strategy-list
// consolidation that removed the duplicated STRATEGY_HINTS source.
// ─────────────────────────────────────────────────
