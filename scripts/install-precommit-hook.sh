...
echo "launched with"
echo "  claude --agent review-opus-agent --worktree <name>"
...
echo "and the temporary worktree is removed automatically. Same severity"
echo "rules apply to whichever reviewer produced the report."
echo
...
echo "  OPUS_TIMEOUT_SEC   default 900  (15 min cap on opus fallback)"
echo
